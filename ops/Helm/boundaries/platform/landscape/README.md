...
<pre lang="json">
{
  ...
  "timeoutSeconds": 15
		...
		<tr>
			<td id="deploy--replicaCount"><a href="./values.yaml#L27">deploy.replicaCount</a></td>
			<td>
int
</td>
			<td>
...
<pre lang="json">
{
  ...
  "readOnlyRootFilesystem": "false"
		...
		<tr>
			<td id="deploy--strategy--rollingUpdate--maxSurge"><a href="./values.yaml#L34">deploy.strategy.rollingUpdate.maxSurge</a></td>
			<td>
int
</td>
			<td>
...
1
		...
		<tr>
			<td id="deploy--strategy--rollingUpdate--maxUnavailable"><a href="./values.yaml#L35">deploy.strategy.rollingUpdate.maxUnavailable</a></td>
			<td>
int
</td>
			<td>
...
0
		...
		<tr>
			<td id="deploy--strategy--type"><a href="./values.yaml#L32">deploy.strategy.type</a></td>
			<td>
string
</td>
			<td>
...
"emptyDir"
		...
		<tr>
			<td id="httpRoute--enabled"><a href="./values.yaml#L17">httpRoute.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="httpRoute--gatewayName"><a href="./values.yaml#L18">httpRoute.gatewayName</a></td>
			<td>
string
</td>
			<td>
...
"external-gateway"
		...
		<tr>
			<td id="httpRoute--gatewayNamespace"><a href="./values.yaml#L19">httpRoute.gatewayNamespace</a></td>
			<td>
string
</td>
			<td>
...
"istio-ingress"
		...
		<tr>
			<td id="httpRoute--hostnames[0]"><a href="./values.yaml#L21">httpRoute.hostnames[0]</a></td>
			<td>
string
</td>
			<td>
...
"landscape.shortlink.best"
		...
		<tr>
			<td id="httpRoute--path"><a href="./values.yaml#L22">httpRoute.path</a></td>
			<td>
string
</td>
			<td>
...
"/"
		...
		<tr>
			<td id="httpRoute--port"><a href="./values.yaml#L23">httpRoute.port</a></td>
			<td>
int
</td>
			<td>
